...
print "blastx=",@blastx_results,"\n";
	...
	my @wise_peps=();
		...
		#do genewise and stonsre the result in an array split with newlines
      		system ("genewise $genewise_pro_in $genewise_gdna_in -diana >$genewise_out");
